...
// 부모클래스에서 상속받아서 변형해서 사용
class SubClass1 extends SuperClass1 {
	
//	오버라이딩 : 상속받은 void instanceMethod () {..}를 재정의한 것
//	void instanceMethod() {
//		System.out.println("SubClass1의 인스턴스 메서드입니다.");
//	}
	
//	오버로딩
//	상속받은 void instanceMethod () {..} -> 가지고 있음
//	아래 메서드는 'void instanceMethod ()' 메서드를 오버로드 한 것 (오버라이딩과는 다름)
	void instanceMethod (String string) {
		System.out.println(string);
	}
	
//	부모 클래스에서 기본 생성자가 없다면(생성자를 따로 만듬)
//	자식 클래스의 생성자에서 반드시 부모 클래스의 생성자를 호출 해야함
	SubClass1 () {
