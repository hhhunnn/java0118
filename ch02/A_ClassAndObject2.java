...
class ExampleClass1 {
	...
	// 오버로딩 : 같은 클래스 내에서 같은 이름의 메서드를 여러개 작성할 수 있도록 하는 바법
	// 오버로딩 조건
	// 1. 메서드 이름을 중복해서 작성하지만 매개변수의 타입 및 개수룰 다르게 작성
	// 2. 메서드의 반환타입과 메서드의 매개변수의 이름은 오버로딩에 영향을 끼치지 않음
	void overloadMethod () {
...
//	} -- Error 매개변수 이름도 영향X
	...
	ExampleClass1(int attribute1) {
		...
		// ampleClass1 (int attribute1, double arg2) {} 호출됨
		// 생성자 내부에서만 부를 수 있음
