...
//	// static 메서드는 인스턴스 변수, 메서드 호출이 불가능
//	
//	// =================================================================
//	
...
////		
////		// static메서드는 인스턴스 변수 접근 및 인스턴스 메서드 호출이 불가능 - 비교////
...
//		
//		
//		System.out.println("=============== static 변수,메서드 ===================");
//		
////		static 변수는 클래스로 직접 접근이 가능
//		ExampleClass1.staticAttribute = 99;
////		instance 변수와 메서드는 '반드시' 인스턴스를 생성하여 인스턴스로 접근 및 호출
////		ExampleClass1.attribute1 = 10; -> Error - 인스턴스 만들고 사용 가능함 
////		ExampleClass1.method(0, 0); -> Error - 
